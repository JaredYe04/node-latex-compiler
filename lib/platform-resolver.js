...
function getRuntimePackageName (platform, arch) {
  if (platform === 'win32' && arch === 'x64') {
    return '@node-tectonic-compiler/bin-win32-x64'
  } else if (platform === 'darwin' && arch === 'x64') {
    return '@node-tectonic-compiler/bin-darwin-x64'
  } else if (platform === 'darwin' && arch === 'arm64') {
    return '@node-tectonic-compiler/bin-darwin-arm64'
  } else if (platform === 'linux' && arch === 'x64') {
    return '@node-tectonic-compiler/bin-linux-x64'
  }
